...
const databaseURL = "https://wordcloud-86f37.firebaseio.com/";
            ...
            <div>
                ...
                <Dialog open={this.state.dialog} onClose={this.handleDialogToggle}>
                    ...
                    <DialogContent>
                        ...
                        <input className={classes.hidden} accept="text/plain" id="raised-button-file" type="file" file={this.state.file} value={this.state.filenName} onChange={this.handleFileChange}/>
